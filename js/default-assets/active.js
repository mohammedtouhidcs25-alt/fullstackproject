(function ($) {
    ...
    var HotelManager_window = $(window);

    // ****************************
    // :: 1.0 Preloader Active Code
    // ****************************

    HotelManager_window.on('load', function () {
    ...
    // ***********************
    if (HotelManager_window.width() > 767) {
        new WOW().init();
    }
